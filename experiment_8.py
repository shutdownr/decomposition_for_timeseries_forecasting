...
RESULTS_FOLDER = "results/experiment_8"
...
def main():
    ...
    for algorithm in c.algorithm_names_long_setup:
        ...
        for dataset in c.dataset_names:
            ...
            for decomp in c.decomp_input_names:
                ...
                horizon = c.long_horizon
                backhorizon = c.long_backhorizon
                ...
                if len(data.y_train) == 0 or len(data.y_val) == 0 or len(data.y_test) == 0:
                    print("Dataset too short, skipping")
                    continue
                ...
                for random_state in np.arange(n_random_states):
                    ...
                    if algorithm in ["GenericLinear", "GenericGRU", "GenericNBeats"]:
